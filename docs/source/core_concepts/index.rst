...
.. code-block:: python
    ...
    total_scores = k2.Fsa.get_tot_scores(fsa, log_semiring=False, use_double_scores=False)
    print(total_scores)
...
.. code-block:: python
    ...
    fsa = k2.Fsa.from_str(s)
    fsa = k2.create_fsa_vec([fsa])
    total_scores = k2.Fsa.get_tot_scores(fsa, log_semiring=True, use_double_scores=False)
    print(total_scores)
...
.. code-block:: python
  ...
  total_scores = k2.Fsa.get_tot_scores(fsa_vec, log_semiring=False, use_double_scores=False)
...
to::
  ...
  total_scores = k2.Fsa.get_tot_scores(fsa_vec, log_semiring=True, use_double_scores=False)
