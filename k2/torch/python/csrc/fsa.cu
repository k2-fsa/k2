...
#include "k2/torch/python/csrc/doc/fsa.h"
...
void PybindFsaClass(py::module &m) {
  ...
  fsa.def("to_str", &FsaClass::ToString);
  ...
  fsa.def("arc_sort", &FsaClass::ArcSort, kFsaAlgoArcSortDoc);
  fsa.def("connect", &FsaClass::Connect, kFsaAlgoConnectDoc);
  fsa.def("top_sort", &FsaClass::TopSort, kFsaAlgoTopSortDoc);
  fsa.def("add_epsilon_self_loops", &FsaClass::AddEpsilonSelfLoops,
