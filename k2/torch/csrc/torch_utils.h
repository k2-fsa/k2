...
#ifndef K2_TORCH_CSRC_TORCH_UTILS_H_
#define K2_TORCH_CSRC_TORCH_UTILS_H_
...
// of FsaClass into `torch::autograd::AutogradContext *ctx`
struct FsaClassHolder : public torch::CustomClassHolder {
  FsaClass *fsas = nullptr;  // not owned by this class
  explicit FsaClassHolder(FsaClass *fsas) : fsas(fsas) {}
};
...
#endif  // K2_TORCH_CSRC_TORCH_UTILS_H_
