...
#ifndef K2_TORCH_CSRC_GRAPH_H_
#define K2_TORCH_CSRC_GRAPH_H_
 ...
 */
FsaClass LinearFsa(RaggedAny &symbols);
 ...
 */
FsaClass LevenshteinGraphs(RaggedAny &symbols, float ins_del_score = -0.501);
